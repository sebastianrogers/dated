...
dated.getBoundary = function(boundaryMoment) {
    const boundary = {};
...
dated.workdays = function(firstMoment, lastMoment) {

    const firstBoundary = dated.getBoundary(firstMoment);
    const lastBoundary = dated.getBoundary(lastMoment);
