describe("sia.dated", function() {
  ...
  describe('Previous Saturdays', function() {
    ...
    it("Saturday", function() {
      ...
      const days = sia.dated.workdays(first, last);
  ...
  describe('Align Dates to Monday Boundary', function() {
    ...
    it("Monday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-02'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Tuesday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-03'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Wednesday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-04'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Thursday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-05'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Friday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-06'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Saturday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-07'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-02').toDate());
    });

    it("Sunday", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-08'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-09').toDate());
    });
    
    it("Monday Week", function() {
      const boundary = sia.dated.getBoundary(moment('2017-10-09'));
      expect(boundary.moment.toDate()).toEqual(moment('2017-10-09').toDate());
    });
  });
